      ...
      >
        <Form>
          <div className="flex gap-7 h-auto">
            ...
            <div className="flex flex-col gap-3 sm:items-center lg:items-start pt-10 sm:w-full md:w-3/5">
              <div className="flex flex-col w-full gap-3 text-2xl">
                ...
                <span className="sm:block md:hidden">
                  <Link href={'/event-organizer/my-events'}>
                    <span
                      className={`${role == 2 ? 'flex items-center justify-center bg-blue-900 rounded-md h-11 w-80 mt-6' : 'hidden'}`}
                    >
                      <IoIosStats className="text-xl text-white" />
